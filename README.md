> **⚠️ Upozornění (CZ)**
>
> Celý tento projekt byl vygenerován umělou inteligencí (Claude Code) **jedním jediným promptem** a slouží **pouze k testovacím účelům**. Nejde o skutečnou aplikaci. Data jsou ukázková, na skutečnou pohotovost se podle nich nespoléhejte.
>
> © 2026 Petr Kaločay, všechna práva vyhrazena. Viz [LICENSE](LICENSE).

> **⚠️ Disclaimer (EN)**
>
> This whole project was generated by AI (Claude Code) from **a single prompt** and exists **for testing purposes only**. It is not a real app. The data is sample data; do not rely on it for real emergency services.
>
> © 2026 Petr Kaločay, all rights reserved. See [LICENSE](LICENSE).
